    ...
    try {
        ...
        unsubscribeSnapshot = onSnapshot(docRef, async (docSnap) => {
            if (docSnap.exists()) {
                ...
                const hydratedProducts = mergeById(subcollectionProducts, cloudData.products || []);
                const hydratedCustomers = mergeById(subcollectionCustomers, cloudData.customers || []);
                const hydratedTransactions = sortTransactionsDesc(mergeById(subcollectionTransactions, cloudData.transactions || []));
                memoryState = {
                    ...initialData,
                    ...cloudData,
