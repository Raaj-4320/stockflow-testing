...
export const updateAccessControlSettings = async (settings: AccessControlSettings) => {
  const data = loadData();
  ...
  await saveData({ ...data, accessControlSettings: sanitized }, { reason: 'updateAccessControlSettings', auditOperation: 'UPDATE', throwOnError: true });
};
