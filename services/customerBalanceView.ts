...
export const getCanonicalCustomerBalanceView = (
  ...
  return {
    ...
    snapshotDue: toSafe(customer.totalDue),
    snapshotStoreCredit: toSafe(customer.storeCredit),
    canonicalDue: toSafe(breakdown.totalDue),
    canonicalStoreCredit: toSafe(breakdown.storeCredit),
  };
};
