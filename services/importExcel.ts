...
export const downloadTransactionsTemplate = () => writeTemplate(
  ...
  [
    ...
    { field: 'Product Barcode', behavior: 'Lookup-only', required: 'Mandatory', format: 'Text', notes: 'Must exist in inventory.', example: 'SKU-1001' },
...
export const downloadTransactionsData = () => {
  ...
  writeDataWorkbook('Transactions', rows, [
    ...
    { field: 'Product Barcode', behavior: 'Lookup-only', required: 'Mandatory', format: 'Text', notes: 'Resolves inventory product for sale/return lines.', example: 'SKU-1001' },
