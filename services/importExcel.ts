...
export const downloadInventoryTemplate = () => writeTemplate(
  ...
  ['SKU-1001', 'Cotton Shirt', 'Apparel', 250, 499, 20, '6109', 'Regular fit cotton shirt'],
  [
...
export const downloadCustomersTemplate = () => writeTemplate(
  'Customers',
  ['Name', 'Phone', 'Total Spend', 'Total Due', 'Visit Count', 'Last Visit (ISO DateTime)'],
  ...
  [
    ...
    { field: 'Total Spend', required: 'Optional', format: 'Number >= 0', notes: 'Opening lifetime spend.', example: '5000' },
    { field: 'Total Due', required: 'Optional', format: 'Number >= 0', notes: 'Opening outstanding due.', example: '750' },
