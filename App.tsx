...
import { can, PermissionKey, restrictedRoutes } from './src/auth/permissions';
  ...
  return (
    <Router>
      ...
      <div className="flex h-screen bg-background overflow-hidden">
        ...
        {authStatus === 'authenticated' && !roleSession && <RoleLoginModal onLogin={setRoleSession} />}
        {/* Sidebar */}
        <div className="w-64 border-r bg-card flex flex-col hidden md:flex">
          ...
          <div className="p-4 border-t flex flex-col gap-2">
             <div className="text-xs text-muted-foreground mt-2">
                <p>User: {currentEmail}</p><p>Access: {roleSession?.role === 'operator' ? `Operator (${roleSession.operatorName})` : roleSession?.role || 'Not selected'}</p>
             </div>
