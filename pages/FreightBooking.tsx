              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 p-4">
                  ...
                  <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
                    <div className="rounded-xl border bg-slate-50 p-3 text-sm">{selectedProduct ? `${formatFreightProductDisplayName(selectedProduct.name)} · ${selectedProduct.category || 'Uncategorized'}` : 'No product selected'}</div>
