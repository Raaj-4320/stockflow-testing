                ...
                <>
                  ...
                  <section className="border rounded-lg p-4 space-y-3">
                    ...
                    <div className="grid gap-3 sm:grid-cols-3">
                      ...
                      <div><Label>CBM/carton</Label><Input type="number" min="0" value={form.cbmPerCartoon} disabled={form.cbmInputMode === 'manual_total'} onChange={e => patchForm({ cbmPerCartoon: Number(e.target.value) || 0 })} /></div>
                      <div><Label>Total CBM {form.cbmInputMode === 'from_cartons' ? '(computed)' : ''}</Label><Input type="number" min="0" value={form.totalCbm} readOnly={form.cbmInputMode === 'from_cartons'} className={form.cbmInputMode === 'from_cartons' ? 'bg-muted/40' : ''} onChange={e => patchForm({ totalCbm: Number(e.target.value) || 0 })} /></div>
