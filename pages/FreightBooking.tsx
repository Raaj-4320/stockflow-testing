            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div>
                ...
                <div className="mt-1 flex gap-2">
                  <Input list="freight-category-options" value={newProductCategory} onChange={e => setNewProductCategory(e.target.value)} placeholder="Select or create category" />
          ...
          <div>
            ...
            <div className="space-y-4">
              {activeLines.map(line => {
                ...
                const totalInr = totalRmb * toNum(exchangeRate);
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div>
                        ...
                        <Input
                          type="number"
                          min="0"
                          value={line.pcs === '' ? '' : String(line.pcs)}
                          onChange={e => updatePricingEntry(line.key, 'pcs', e.target.value)}
                        />
                      </div>
                      <div>
                        <Label>RMB/Pcs</Label>
                        <Input type="number" min="0" value={line.rmbPerPcs === '' ? '' : String(line.rmbPerPcs)} onChange={e => updatePricingEntry(line.key, 'rmbPerPcs', e.target.value)} />
                      </div>
                    </div>
                  </div>
                );
