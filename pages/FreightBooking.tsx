              ...
              <div className="space-y-4">
                ...
                <div className="rounded-2xl border border-slate-200 p-4">
                  ...
                  <div className="grid gap-3 lg:grid-cols-[1fr_auto]">
                    ...
                    <Button type="button" variant="outline" disabled={sourceMode==='new' && !!newProductName.trim()} onClick={() => { setSourceMode('inventory'); setNewProductName(''); setNewProductCategory(''); setNewProductImage(''); setNewProductImageFile(null); setIsExistingProductPickerOpen(true); setExistingPickerMode('products'); }}>Select Product</Button>
                  </div>
                </div>
