...
import { resolveAvailableStoreCredit } from '../services/credit';
...
export default function Sales() {
  ...
  const completeCheckout = () => {
      ...
      const availableCredit = !isReturnMode ? resolveAvailableStoreCredit(finalCustomer, creditLedger) : 0;
      ...
      const tx: Transaction = {
          ...
          customerId: finalCustomer?.id, customerName: finalCustomer?.name, paymentMethod, returnExcessMode: isReturnMode ? returnExcessMode : undefined, useStoreCredit: !isReturnMode ? safeUseStoreCredit : false
      };
          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-[80] flex items-center justify-center p-4">
              <Card className="w-full max-w-md animate-in zoom-in-95 shadow-2xl">
                  <CardHeader className="border-b pb-4">
                      ...
                      {!isReturnMode && selectedCustomer && resolveAvailableStoreCredit(selectedCustomer, creditLedger) > 0 && (
                        <div className="mb-3 rounded-lg border border-blue-200 bg-blue-50 p-3 space-y-2">
                          <div className="flex items-center justify-between">
                            ...
                            <span className="text-xs font-bold text-blue-700">₹{resolveAvailableStoreCredit(selectedCustomer, creditLedger).toFixed(2)}</span>
                          </div>
