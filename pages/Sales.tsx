        ...
        <div className="fixed inset-0 bg-black/70 z-[90] flex items-center justify-center p-4" onClick={() => setIsReturnPopupOpen(false)}>
          <Card className="w-full max-w-5xl max-h-[90vh] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <CardHeader className="border-b py-3">
              <CardTitle className="text-[17px] font-semibold truncate">
                Create Return — #{selectedReturnTx.id} | {new Date(selectedReturnTx.date).toLocaleString()} | {selectedReturnTx.customerName || 'Walk-in customer'}
              </CardTitle>
            </CardHeader>
            <CardContent className="p-3 space-y-3 overflow-y-auto max-h-[calc(90vh-138px)]">
              <div className="grid gap-1.5 md:grid-cols-3 text-[13px] rounded-lg border p-2.5 bg-muted/10">
                ...
                <div className="space-y-1.5">
                  ...
                  {selectedReturnLines.map((line) => {
                    ...
                    <div key={line.key} className="rounded-md border px-2 py-1.5">
                      <div className="grid grid-cols-[30px_minmax(0,1fr)_72px_58px_64px_74px] md:grid-cols-[34px_minmax(0,1fr)_90px_76px_74px_88px] items-center gap-1.5 md:gap-2 text-[13px]">
