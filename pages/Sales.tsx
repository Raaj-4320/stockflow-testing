  ...
  const completeCheckout = () => {
      ...
      const tx: Transaction = {
          ...
          saleSettlement: isReturnMode ? undefined : {
            cashPaid: paymentMethod === 'Cash' ? payableAfterCredit : 0,
            onlinePaid: paymentMethod === 'Online' ? payableAfterCredit : 0,
            creditDue: paymentMethod === 'Credit' ? payableAfterCredit : 0,
          }
      };
