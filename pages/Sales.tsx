...
export default function Sales() {
  ...
  const completeCheckout = () => {
      ...
      if (!isReturnMode) {
          ...
          if (checkoutMoney.hasWholeOverpay && !canSaveOverpayAsStoreCredit) {
      ...
      if (!isReturnMode && Math.abs(splitTotal - payableAfterCreditWhole) > 0.001) {
  ...
  const canSaveOverpayAsStoreCredit = !isReturnMode && rawOverpaymentValue > 0 && Boolean(selectedCustomer) && storeOverpaymentAsCredit;

  console.log("[OVERPAY DEBUG]", {
    rawOverpaymentValue,
    selectedCustomerId: selectedCustomer?.id,
    canSaveOverpayAsStoreCredit,
          ...
          <div className="flex-1 overflow-y-auto p-3 space-y-3">
            ...
            <div className="space-y-2 rounded-lg border p-2.5 bg-muted/10">
                  ...
                  <div className="space-y-2">
                    ...
                    {selectedCustomer ? (
                      <label className="flex items-center gap-2 text-xs">
                        <input type="checkbox" checked={storeOverpaymentAsCredit} onChange={(e) => setStoreOverpaymentAsCredit(e.target.checked)} />
                        Save change as store credit
                      </label>
                    ) : <div className="text-[11px] text-muted-foreground">Select or create a customer to save store credit.</div>}
                  </div>
              ...
              <div className="text-xs space-y-1 border-t pt-2">
                ...
                {hasSettlementOverpay && !canSaveOverpayAsStoreCredit && (
