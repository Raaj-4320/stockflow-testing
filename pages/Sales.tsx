                  ...
                  <div className="rounded-lg border p-3 space-y-2 bg-muted/10">
                    ...
                    {storeCreditMode === 'custom' && (
                      <div className="space-y-1">
                        <Input type="number" min="0" step="0.01" value={customStoreCreditUse} onChange={(e) => setCustomStoreCreditUse(e.target.value)} placeholder="Enter amount" />
                        <p className="text-[11px] text-muted-foreground">Max usable: ₹{maxApplicableStoreCredit.toFixed(2)}</p>
                      </div>
                    )}
