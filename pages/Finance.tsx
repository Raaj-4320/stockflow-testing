...
export default function Finance() {
  ...
  const closeShift = async () => {
    ...
    let shiftApprovedBy: 'operator' | 'admin' = roleSession?.role === 'operator' ? 'operator' : 'admin';
    let adminOverrideAt: string | undefined;
    if (roleSession?.role === 'operator' && Math.abs(difference) > 100) {
                  ...
                  <div className="flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm min-h-0">
                    ...
                    <div className="flex-1 min-h-0 overflow-auto p-4">
                      <div className="space-y-3">
                        ...
                        {can(roleSession, 'cashWithdrawal') && (
