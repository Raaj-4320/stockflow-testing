...
export default function Finance() {
  ...
  const expectedClosingBreakdown = useMemo(() => {
    ...
    return {
      ...
      activeCashSales: Math.max(0, (dailyCashTotals.cashSales || 0) - (dailyCashTotals.deletedSaleCashIncluded || 0)),
      deletedSaleCashIncludedForRefundOffset: dailyCashTotals.deletedSaleCashIncluded || 0,
