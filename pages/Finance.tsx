              ...
              <Card className="border-slate-200 shadow-sm">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <StatCard label="Current Opening" value={formatINR(openSession?.openingBalance ?? Number(openingBalance || 0))} />
                    <StatCard label="System Cash Total (live)" value={formatINR(dailyCashTotals.systemCashTotal)} />
                  </div>
                    ...
                    <>
                      ...
                      <div className="space-y-2 max-h-72 overflow-auto pr-1">
                        {CLOSING_DENOMS.map(denom => {
                          ...
                          return (
                            <div key={denom} className="flex items-center justify-between rounded-lg border px-3 py-2">
