                  ...
                  {openingUnlocked && openSession && (
                    <div className="space-y-2 p-3 rounded-xl border bg-muted/20">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="flex w-full items-center rounded-xl border bg-background px-3">
                          <span className="text-muted-foreground">₹</span>
                          <Input type="text" inputMode="numeric" className="border-0 shadow-none focus-visible:ring-0" value={openingBalanceEditValue} onChange={e => setOpeningBalanceEditValue(e.target.value.replace(/[^\d]/g, ''))} placeholder="0" />
                        </div>
