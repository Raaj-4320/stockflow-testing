...
export default function Finance() {
  ...
  const todayFinanceBreakdown = useMemo(() => {
    ...
    const scoped = buildCanonicalFinanceBreakdown(data.transactions, expenses, windowStart, windowEnd);
  ...
  const dailySummary = useMemo(() => {
    ...
    const summary = buildCanonicalFinanceBreakdown(data.transactions, expenses, dayStart, dayEnd);
  ...
  const monthlySummary = useMemo(() => {
    ...
    const summary = buildCanonicalFinanceBreakdown(data.transactions, expenses, monthStart, monthEnd);
