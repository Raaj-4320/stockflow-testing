            ...
            <Card className="border-slate-200 shadow-sm bg-white">
              ...
              <CardContent className="space-y-3 pt-5">
                {filteredCashHistory.map(session => {
                  ...
                  const sessionEndTs = session.endTime ? new Date(session.endTime).getTime() : Number.POSITIVE_INFINITY;
                            ...
                            <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                              <div className="flex items-start justify-between gap-3 border-b border-slate-200 p-4">
                                <div>
                                  ...
                                  <div className="mt-0.5 text-xs text-slate-500">({new Date(session.startTime).toLocaleDateString()})</div>
                                </div>
