...
export default function Dashboard() {
  ...
  const handleReceive = async () => {
    ...
    const breakdown = receivingCustomer ? getCustomerCompositeReceivableBreakdown(receivingCustomer.id, customers, transactions, upfrontOrders) : { canonicalDue: 0, customOrderDue: 0 };
