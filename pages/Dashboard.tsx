...
export default function Dashboard() {
  ...
  const canonicalCustomerBalanceById = useMemo(() => {
    ...
    customers.forEach((customer) => {
      ...
      if (import.meta.env.DEV) console.log('[CUSTOMER BALANCE VIEW]', { customerId: view.customerId, snapshotDue: view.snapshotDue, canonicalDue: view.canonicalDue, snapshotStoreCredit: view.snapshotStoreCredit, canonicalStoreCredit: view.canonicalStoreCredit });
    });
    return map;
