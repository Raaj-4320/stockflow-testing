...
const customerReceivables = useMemo<CustomerReceivableRow[]>(() => customers
  ...
  const erpDataSnapshot = useMemo(() => loadData(), [transactions, orders, supplierPayments, customers, products, cashSessions, expenses, deleteCompensations, upfrontOrders]);
  const erpCompareInput = useMemo(() => ({
    transactions,
    deletedTransactions: erpDataSnapshot.deletedTransactions || [],
    deleteCompensations: deleteCompensations || [],
    supplierPayments: supplierPayments || [],
    purchaseOrders: orders || [],
    manualCashbookEntries: erpDataSnapshot.manualCashbookEntries || [],
    upfrontOrders,
    customers,
    products,
    cashSessions,
    expenses: expenses || [],
  }), [transactions, erpDataSnapshot, deleteCompensations, supplierPayments, orders, upfrontOrders, customers, products, cashSessions, expenses]);
